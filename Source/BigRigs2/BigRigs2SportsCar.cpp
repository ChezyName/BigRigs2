...
#include "BigRigs2SportsCar.h"
#include "BigRigs2SportsWheelFront.h"
#include "BigRigs2SportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ABigRigs2SportsCar::ABigRigs2SportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UBigRigs2SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UBigRigs2SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UBigRigs2SportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UBigRigs2SportsWheelRear::StaticClass();
