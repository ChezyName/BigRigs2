...
#include "BigRigs2OffroadCar.h"
#include "BigRigs2OffroadWheelFront.h"
#include "BigRigs2OffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ABigRigs2OffroadCar::ABigRigs2OffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UBigRigs2OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UBigRigs2OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UBigRigs2OffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UBigRigs2OffroadWheelRear::StaticClass();
